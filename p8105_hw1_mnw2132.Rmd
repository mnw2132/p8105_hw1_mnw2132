...
The logical variables get coded as 1 or 0, which causes the mean=0.5. Meanwhile, the factor variable can get coded in regard to the levels of 1-3, thereby creating a mean of 2. However, the character variables get changed into NA's by coercion, therefore a mean still cannot be calculate as the variables are NA. 
